...
ควรหลีกเลี่ยงที่จะติดตั้ง packages อื่นๆที่ไม่จำเป็น เพื่อที่จะได้ช่วยลดความซับซ้อน ลดส่วนของซอฟแวร์ที่ไม่จำเป็น ลดขนาดของไฟล์ และลดระยะเวลาในการ build 
ไม่ใช่เพียงเพราะคุณเห็นเป็น packages ที่อยากจะเก็บไว้ เช่น คุณไม่จำเป็นต้องใช้ text editor ใน database image.
